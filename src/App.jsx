  ...
  const addSecretary = () => {
    createUserWithEmailAndPassword(auth, secretary.email, secretary.password)
      .then((userCredential) => {
        ...
        set(newSecretaryRef, { name: secretary.name, email: secretary.email, phone: secretary.phone, role: "secretary" }).then(() => {
  ...
  return (
    <div>
      ...
      <input
        ...
        value={lawyer.lawFirm}
        onChange={(e) => setLawyer({ ...lawyer, lawFirm: e.target.value })}
      />
      <input
        type="text"
      ...
      <input
        ...
        onChange={(e) => setLawyer({ ...lawyer, contact: { ...lawyer.contact, phone: e.target.value } })}
      />
      <input
        type="email"
        placeholder="Email"
        value={lawyer.contact.email}
        onChange={(e) => setLawyer({ ...lawyer, contact: { ...lawyer.contact, email: e.target.value } })}
      />
      <input
        type="text"
        placeholder="Address"
        value={lawyer.contact.address}
        onChange={(e) => setLawyer({ ...lawyer, contact: { ...lawyer.contact, address: e.target.value } })}
      />
